...
(function () {
  ...
  const STRINGS = {
    es: {
      ...
      lock_tagline: 'Tus API keys, cifradas y bajo tu control.',
      lock_lead: 'Una bóveda cifrada para guardar y organizar tus API keys. Funciona 100% en tu dispositivo, sin servidor, sin telemetría, sin nube.',
      unlock_label: 'Abrir / crear bóveda',
    ...
    en: {
      ...
      lock_tagline: 'Your API keys, encrypted and under your control.',
      lock_lead: 'An encrypted vault to store and organize your API keys. It runs 100% on your device, no server, no telemetry, no cloud.',
      unlock_label: 'Open / create vault',
