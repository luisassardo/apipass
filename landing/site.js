...
(function () {
  ...
  const STRINGS = {
    es: {
      ...
      f2_d: 'Agrupa por servicio, proyecto y entorno (dev / staging / prod). Adjunta certificados y archivos. Busca al instante. Recordatorio de rotación.',
    ...
    en: {
      ...
      hero_note: 'macOS (Intel + Apple Silicon) · signed and notarized by Apple · free and open source',
      ...
      f2_d: 'Group by service, project and environment (dev / staging / prod). Attach certificates and files. Instant search. Rotation reminders.',
